...
export class VillagerPair extends EventTarget {
  constructor(map, x1, y1, x2, y2, offsetX = 64, type1 = 0, type2 = 1) {
    super();
    this.villager1 = new Villager(map, x1, y1, type1);
    this.villager2 = new Villager(map, x2, y2, type2);
